...
const events = [
  ...
  { id: "2", day: "15", month: "Jun", title: "Community Food Drive",        time: "10:00 AM – 2:00 PM", location: "Community Centre", description: "Serving hot meals and food parcels to families in need. Volunteers welcome — contact the church to help.",                                    category: "Outreach"        },
  ...
  { id: "4", day: "29", month: "Jun", title: "Men's Breakfast & Prayer",    time: "7:00 AM",             location: "Church Hall",     description: "Monthly men's breakfast featuring devotion, discussion, and prayer. All men in the congregation are welcome.",                              category: "Men's Ministry"  },
  ...
  { id: "6", day: "20", month: "Jul", title: "Prayer and Fasting Week",     time: "All Week",            location: "Church & Online", description: "A week of corporate prayer and fasting. Daily 6:00 AM prayer meetings and evening devotionals.",                                            category: "Prayer"          },
];
    ...
    <div>
      ...
      <section className="relative bg-navy-800 text-white py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1920&q=75" alt="" fill className="object-cover opacity-15" priority />
        </div>
