    ...
    <div>
      ...
      <section className="relative bg-navy-700 text-white py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1920&q=75" alt="" fill className="object-cover opacity-20" priority />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumb items={[{ label: "Services" }]} />
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4">Services</h1>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10">
            <Link
              href="/ministries"
              className="bg-navy-700 text-white font-bold px-8 py-3 rounded-lg hover:bg-navy-600 active:scale-95 transition-all duration-200 inline-block"
            >
              View All Ministries
            </Link>
          </div>
